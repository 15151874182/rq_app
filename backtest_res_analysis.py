...
##future23 目前最佳
zz1000=rqdatac.futures.get_dominant_price(underlying_symbols='IM'
                                         ,start_date=20230901,end_date=20250919,
                                         frequency='1d',fields=None,
                                         adjust_type='none', 
                                         rule=2,
                                         rank=3,
...
xx.loc['2025-08-19','future23_return']=0
...
zz1000=rqdatac.futures.get_dominant_price(underlying_symbols='IM'
                                         ,start_date=20230901,end_date=20250919,##时间要改
                                         frequency='1d',fields=None,
                                         adjust_type='none', 
                                         rule=2,
                                         rank=3,
...
zz1000['future23_return']=zz1000['close']/zz1000['prev_settlement']-1
xx['future23_return']=zz1000['future23_return']
xx.loc['2025-08-19','future23_return']=0   ##时间要改
